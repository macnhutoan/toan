                                    ...
                                    <div class="basic-details">
                                        <div class="row clearfix">
                                            <div class="image-column col-md-6 col-sm-12">
                                                <figure class="image-box"><a class="lightbox-image" title="Image Caption Here"><img src="${f.image}" alt=""></a></figure>
                                            </div>
                                            <div class="info-column col-md-6 col-sm-12">
                                                <div class="details-header">
                                                    <h4>${f.name}</h4>
                                                    <a class="reviews">Restaurant : ${f.restaurant.name}</a><br>
                                                    <c:if test="${f.numberComment > 0}">
                                                        <div class="rating">
                                                    ...
                                                    <a class="reviews" href="#">( ${f.numberComment}  Reviews )</a>
                                                </div>

                                                <div class="text">${f.detail}</div>
                                        ...
                                        <div class="prod-tabs tabs-box">
                                            ...
                                            <div class="tabs-content">
                                                ...
                                                <div class="tab active-tab" id="prod-reviews">
                                                    <h2 class="title">${r.numberComment} Reviews For ${f.name}</h2>
                                                        ...
                                                        <c:forEach var="i" items="${listR}">
                                                                ...
                                                                <div class="comment-box">
                                                                    <div class="comment">
                                                                        ...
                                                                        <div class="comment-inner">
                                                                            ...
                                                                            <c:if test="${sessionScope.account.id == i.account.id}">
                                                                                 <div><a onclick="document.getElementById(${i.id}).style.display = 'block'">Edit</a> | <a href="main?action=remove-review-restaurant&id=${i.id}&re_id=${r.id}">Remove</a></div>
                                                                            </c:if>
                                                            ...
                                                            <div class="shop-comment-form mb-3" id="${i.id}" style="display: none;"> 
                                                                <form method="post" action="main">
                                                                    <input type="hidden" value="edit-review-food" name="action">
                                                                    <input type="hidden" value="${f.id}" name="fo_id">
                                                    ...
                                                    <div class="shop-comment-form"> 
                                                        <form method="post" action="main">
                                                            <input type="hidden" value="add-review-food" name="action">
