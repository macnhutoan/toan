                        ...
                        <div class="footer-column col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="footer-widget about-widget">
                                <div class="footer-logo">
                                    <figure>
                                        <a href="main"><img style="width: 100px;height: 100px;border-radius: 20px" src="images/download (1).jpg" alt="" title=""></a>
                                    </figure>
                                </div>
                                <div class="widget-content">
                                    <div class="text">Our website offers detailed and authentic reviews of dining spots, hotels, and exciting destinations in Da Nang. From fine dining restaurants and street food stalls to unique coffee shops, we help you discover the best culinary and leisure experiences. Explore, enjoy, and share your thoughts with a community of food and travel enthusiasts!</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-widget links-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="list">
                                        ...
                                        <li><a href="https://www.facebook.com/macnhutoan/">Contact Us</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <div class="auto-container">
            <div class="inner-container clearfix">
                ...
                <div class="copyright-text">
                    <a href="https://www.templateshub.net" target="_blank">OTID</a>
                </div>
            </div>
        </div>
    </div>
